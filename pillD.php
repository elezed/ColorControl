 ...
 ?> 
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer1">
    ...
    <div class="freccias"><a href="allarmiD.php"><i class="fa fa-arrow-left" style="font-size:36px;color:white"></i></a></div>
	<div class="frecciad"><a href="appuntamentiD.php"><i class="fa fa-arrow-right" style="font-size:36px;color:white"></i></a></div>
