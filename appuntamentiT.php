 ...
 ?> 
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer2">
    ...
    <div class="freccias"><a href="pillT.php"><i class="fa fa-arrow-left" style="font-size:36px;color:white"></i></a></div>
	<div class="frecciad"><a href="paginainizialeT.php"><i class="fa fa-arrow-right" style="font-size:36px;color:white"></i></a></div>
