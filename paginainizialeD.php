...
<div class="wrapper">
    ...
    <div class="content-wrapper1" >
        ...
        <section class="content-header">
            <h1>
                <a href="paginainizialeD.php"  class="titolo"><i class="fa fa-home"></i>Pagina Inziale</a>
            ...
            <div class="row"> 
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box " style="background-color: #8E446F">
                        ...
                        <a href="lightD.php" class="small-box-footer1">Aggiungi luci <i class="fa fa-arrow-circle-right"></i></a>
                        </a>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box " style="background-color: #D73000">
                        ...
                        <a href="allarmiD.php" class="small-box-footer1">Aggiungi allarme<i class="fa fa-arrow-circle-right"></i></a>
							</a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box  " style="background-color: #0C73B3">
                        ...
                        <a href="pillD.php" class="small-box-footer1">Aggiungi medicina <i class="fa fa-arrow-circle-right"></i></a>
                        </a></div>
                </div>
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box " style="background-color: #B65423 ">
                        ...
                        <a href="appuntamentiD.php" class="small-box-footer1">Aggiungi evento <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
...
<div class="row">
 ...
 ?> 
    ...
    <footer class="main-footer1">
        ...
        <div class="frecciad"><a href="lightD.php"><i class="fa fa-arrow-right" style="font-size:36px;color:white"></i></a></div>
