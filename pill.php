 ...
 ?> 
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer1">
    ...
    <div class="freccias"><a href="allarmi.php"><i class="fa fa-arrow-left" style="font-size:36px;color:white"></i></a></div>
	<div class="frecciad"><a href="appuntamenti.php"><i class="fa fa-arrow-right" style="font-size:36px;color:white"></i></a></div>
