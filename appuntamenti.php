...
<?php
 if(isset($_POST['submit'])){
	...
	$id_utente = $id;
	$sql = "INSERT INTO appuntamenti (nome, luogo, note, timepicker, dataI, dataF, id_utente) VALUES ('$nome', '$luogo', '$note','$timepicker','$dataI_','$dataF_','$id_utente')";
   // echo $sql;
...
/*$sql = 'SELECT * 
		FROM medicine';*/
	$id_utente = $id;
	$sql="SELECT nome,luogo,note,timepicker,dataI,dataF FROM appuntamenti WHERE id_utente=  '$id'";
...
<head>
  ...
  <title>Appuntamenti-Color Light Control</title>
...
<div class="wrapper">
 ...
 <a href="appuntamenti.php">             
			 <h3 id="small"  class="bianco">Calendario</h3>
	...
	<br>
      ...
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="row">
        ...
        <strong>Pannello Controllo Appuntamenti</strong>
      </h1>
      ...
      <!-- Main row -->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Aggiungi un appuntamento</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"  method="POST">
              <div class="boxMedicine">
                <div class="form-group">
                  <label for="nome">Nome dell'Appuntamento</label>
                  <input type="text" class="form-control" name="nome" placeholder="Inserisci nome dell'appuntamento">
                </div>
                <div class="form-group">
                  <label for="Dose">Luogo</label>
                 <input type="text" class="form-control" name="luogo" placeholder="Inserisci la Località">
				 
                </div>
                
               <div class="form-group">
                  <label for="nome">Note</label>
                  <input type="text" class="form-control" name="note" placeholder="Inserisci note">
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name ="submit" class="btn btn-primary">Aggiungi evento</button>
              </div>
            </form>
          </div>
	...
	<div class="box">
            <div class="box-header">
              <h3 class="box-title">Appuntamenti</h3>
 ...
 ?> 
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer1">
    ...
    <div class="freccias"><a href="pill.php"><i class="fa fa-arrow-left" style="font-size:36px;color:white"></i></a></div>
	<div class="frecciad"><a href="paginainiziale.php"><i class="fa fa-arrow-right" style="font-size:36px;color:white"></i></a></div>
